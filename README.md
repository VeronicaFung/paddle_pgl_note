...
<br>![image](C:/Users/fengf/Desktop/dpl/application.png)


###图神经网络
<br>![image](C:/Users/fengf/Desktop/dpl/GNN.png)

### 消息传递机制
消息传递包括两部分：
<br>**Send**: 源节点发送消息，即边上的源节点，往目标节点发送特征
<br>**Recv**: 目标节点接受消息，即目标节点对收到的特征进行聚合
<br>![image](C:/Users/fengf/Desktop/dpl/message passing.png)
### 图卷积神经网络GCN
<br>图卷积神经网络（Graph Convolutional Network, GCN）
<br>**图像卷积**:将一个像素点周围的像素按照不同的权重叠加起来。
<br>**图结构卷积**:将一个节点周围的邻居按照不同的权重叠加起来。
<br>![image](C:/Users/fengf/Desktop/dpl/gcn_formula.JPG)
<br>附上一个学习时手写的结构，包括了前边描述的消息传递过程，合GCN中关键公式的一步步解析：
<br>![image](C:/Users/fengf/Desktop/dpl/gcn_structure_handwriting.jpg)
...
### 图注意力网络GAT
<br>![image](C:/Users/fengf/Desktop/dpl/gat_paddle.JPG)
 <br>GAT(Graph attention network)优势相比于GCN(等权重对邻居信息进行卷积操作)在于通过 Attention 机制，为不同节点分配不同权重。GAT可以采用单头或者多头的注意力机制[2]：
<br>![image](C:/Users/fengf/Desktop/dpl/gat_frompaper.JPG)
<br>具体计算时，单头的GAT[3]:
<br>![image](C:/Users/fengf/Desktop/dpl/gat_单头.JPG)
<br>多头GAT[3]:
<br>![image](C:/Users/fengf/Desktop/dpl/gat_多头.JPG)
...
<br>**原文中的模型框架**
<br>![image](C:/Users/fengf/Desktop/dpl/example_workflow.JPG)
<br>**文章理解**
...
**3. 该算法的performance？**
<br>![image](C:/Users/fengf/Desktop/dpl/performance.JPG)
